        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl sm:text-4xl mb-6 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent" style={{ fontWeight: 700 }}>
              ...
              <div className="space-y-6 mb-12">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:1-800-EQUITY" className="text-purple-600 hover:text-purple-700 text-lg">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@equitykey.com" className="text-purple-600 hover:text-purple-700 text-lg">
                      hello@equitykey.com
                    </a>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-6 border border-purple-200">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-purple-600" style={{ fontWeight: 600 }}>2 hours</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Customer Satisfaction</span>
                    <span className="text-purple-600" style={{ fontWeight: 600 }}>4.9/5</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Homeowners Helped</span>
                    <span className="text-purple-600" style={{ fontWeight: 600 }}>50,000+</span>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-xl border border-gray-200">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <motion.button
                    type="submit"
                    className="w-full px-6 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
